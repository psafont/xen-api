...
let get_uuid_from_ref_or_null r =
  if r = Ref.null then nullref else get_uuid_from_ref r
...
let network_sriov_record rpc session_id network_sriov =
  ...
  ; fields =
      [ make_field
          ~name:"uuid"
          ~get:(fun () -> (x ()).API.network_sriov_uuid)
          ()
      ; make_field
          ~name:"physical-PIF"
          ~get:(fun () ->
      ...
      ; make_field
          ...
          ~get:(fun () ->
            try
              Int64.to_string
                (Client.Network_sriov.get_remaining_capacity
                   rpc
                   session_id
                   network_sriov )
            with
      ...
      ; make_field
          ...
          ~get:(fun () ->
            Option.fold
              ~none:nid
              ~some:(fun m ->
                if m.API.pIF_metrics_duplex
                then "full"
                else if m.API.pIF_metrics_carrier
                then "half"
                else "unknown" )
              (xm ()) )
          ()
      ; make_field
          ~name:"disallow-unplug"
          ~get:(fun () -> string_of_bool (x ()).API.pIF_disallow_unplug)
          ~set:(fun disallow_unplug ->
            Client.PIF.set_disallow_unplug
              rpc
              session_id
              pif
...
let task_record rpc session_id task =
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~get:(fun () ->
            map_and_concat
              Record_util.task_allowed_operations_to_string
...
let vif_record rpc session_id vif =
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~get:(fun () ->
            map_and_concat
              Record_util.vif_operation_to_string
...
let pool_record rpc session_id pool =
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~set:(fun x ->
            let sr_ref =
              if x = ""
              then Ref.null
              else Client.SR.get_by_uuid rpc session_id x
            in
      ...
      ; make_field
          ...
          ~get:(fun () ->
            map_and_concat
              Record_util.pool_operation_to_string
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"ha-host-failures-to-tolerate"
          ~get:(fun () ->
            Int64.to_string (x ()).API.pool_ha_host_failures_to_tolerate )
          ~set:(fun x ->
            Client.Pool.set_ha_host_failures_to_tolerate
              rpc
              session_id
              pool
              (Int64.of_string x) )
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"wlb-verify-cert"
          ~get:(fun () -> string_of_bool (x ()).API.pool_wlb_verify_cert)
          ~set:(fun x ->
            Client.Pool.set_wlb_verify_cert
              rpc
              session_id
              pool
              (bool_of_string x) )
          ()
      ; make_field
          ~name:"igmp-snooping-enabled"
          ~get:(fun () -> string_of_bool (x ()).API.pool_igmp_snooping_enabled)
          ~set:(fun x ->
            Client.Pool.set_igmp_snooping_enabled
              rpc
              session_id
              pool
              (bool_of_string x) )
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"ha-cluster-stack"
          ~get:(fun () -> (x ()).API.pool_ha_cluster_stack)
          ()
      ; make_field
          ~name:"guest-agent-config"
          ~get:(fun () ->
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"policy-no-vendor-device"
          ~get:(fun () -> string_of_bool (x ()).API.pool_policy_no_vendor_device)
          ~set:(fun s ->
            Client.Pool.set_policy_no_vendor_device
              rpc
              session_id
              pool
          ...
          ()
      ; make_field
          ~name:"live-patching-disabled"
          ~get:(fun () -> string_of_bool (x ()).API.pool_live_patching_disabled)
          ~set:(fun s ->
            Client.Pool.set_live_patching_disabled
              rpc
              session_id
              pool
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"client-certificate-auth-name"
...
let vmss_record rpc session_id vmss =
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~set:(fun x ->
            Client.VMSS.set_retained_snapshots
              rpc
              session_id
              vmss
      ...
      ; make_field
          ...
          ~get:(fun () ->
            try
              map_and_concat
                (fun self ->
                  try Client.Role.get_name_label rpc session_id self with
                  | _ ->
                      nid )
...
let vm_record rpc session_id vm =
  ...
  let empty_guest_metrics =
    ToGet
      (fun () ->
        try
          Some
            (Client.VM_guest_metrics.get_record
               rpc
               session_id
  ...
  ; fields =
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"is-default-template"
          ~get:(fun () -> string_of_bool (x ()).API.vM_is_default_template)
          ~set:(fun x ->
            Client.VM.set_is_default_template
              rpc
              session_id
              vm
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"transportable-snapshot-id"
          ~hidden:true
      ...
      ; make_field
          ...
          ~set:(fun x ->
            Client.VM.set_memory_static_max
              rpc
              session_id
              vm
      ...
      ; make_field
          ...
          ~set:(fun x ->
            Client.VM.set_memory_dynamic_max
              rpc
              session_id
              vm
      ...
      ; make_field
          ...
          ~set:(fun x ->
            Client.VM.set_memory_dynamic_min
              rpc
              session_id
              vm
      ...
      ; make_field
          ...
          ~set:(fun x ->
            Client.VM.set_memory_static_min
              rpc
              session_id
              vm
          ...
          ()
      ; make_field
          ~name:"suspend-VDI-uuid"
          ~get:(fun () -> get_uuid_from_ref (x ()).API.vM_suspend_VDI)
          ~set:(fun x ->
            Client.VM.set_suspend_VDI
              rpc
              session_id
              vm
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"VCPUs-at-startup"
          ~get:(fun () -> Int64.to_string (x ()).API.vM_VCPUs_at_startup)
          ~set:(fun x ->
            Client.VM.set_VCPUs_at_startup
              rpc
              session_id
              vm
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"actions-after-reboot"
          ~get:(fun () ->
            Record_util.on_normal_exit_to_string
              (x ()).API.vM_actions_after_reboot )
          ~set:(fun x ->
            Client.VM.set_actions_after_reboot
              rpc
              session_id
              vm
              (Record_util.string_to_on_normal_exit x) )
      ...
      ; make_field
          ...
          ~get:(fun () ->
            map_and_concat
              Record_util.vm_operation_to_string
      ...
      ; make_field
          ...
          ~add_to_map:(fun k v ->
            Client.VM.add_to_blocked_operations
              rpc
              session_id
              vm
              ...
              v )
          ~remove_from_map:(fun k ->
            Client.VM.remove_from_blocked_operations
              rpc
              session_id
              vm
              (Record_util.string_to_vm_operation k) )
      ...
      ; (* These two don't work on Dom-0 at the moment, so catch the exception *)
        make_field
          ~name:"allowed-VBD-devices"
          ~get:(fun () ->
            concat_with_semi
              ( try Client.VM.get_allowed_VBD_devices rpc session_id vm with
              | _ ->
                  [] ) )
          ~expensive:true
          ~get_set:(fun () ->
          ...
          ()
      ; make_field
          ~name:"allowed-VIF-devices"
          ~get:(fun () ->
            concat_with_semi
              ( try Client.VM.get_allowed_VIF_devices rpc session_id vm with
              | _ ->
                  [] ) )
          ~expensive:true
          ~get_set:(fun () ->
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"HVM-shadow-multiplier"
          ~get:(fun () -> string_of_float (x ()).API.vM_HVM_shadow_multiplier)
          ~set:(fun x ->
            Client.VM.set_HVM_shadow_multiplier
              rpc
              session_id
              vm
              (float_of_string x) )
      ...
      ; make_field
          ...
          ~set:(fun x ->
            if x = ""
            then Client.VM.set_affinity rpc session_id vm Ref.null
            else
              Client.VM.set_affinity
                rpc
                session_id
                vm
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"guest-metrics-last-updated"
          ~get:(fun () ->
            Option.fold
              ~none:nid
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"cooperative" (* NB this can receive VM_IS_SNAPSHOT *)
          ~get:(fun () ->
            string_of_bool
      ...
      ; make_field
          ...
          ~set:(fun x ->
            if x = ""
            then Client.VM.set_appliance rpc session_id vm Ref.null
            else
              Client.VM.set_appliance
                rpc
                session_id
                vm
      ...
      ; make_field
          ...
          ~set:(fun x ->
            if x = ""
            then Client.VM.set_snapshot_schedule rpc session_id vm Ref.null
            else
              Client.VM.set_snapshot_schedule
                rpc
                session_id
                vm
      ...
      ; make_field
          ...
          ~set_map:(fun x ->
            List.iter
              (fun (k, v) ->
                if not (List.mem k Constants.settable_vm_bios_string_keys)
                then
                  raise
                    (Record_util.Record_failure
                       ( "Unknown key '"
          ...
          ()
      ; make_field
          ~name:"pending-guidances"
          ~get:(fun () ->
            map_and_concat
              Record_util.update_guidance_to_string
...
let host_record rpc session_id host =
    ...
    ref
      (ToGet
         (fun () ->
           try
             Some
               (Client.Host_metrics.get_record
                  rpc
                  session_id
                  (x ()).API.host_metrics )
           with
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~get:(fun () ->
            map_and_concat
              Record_util.host_operation_to_string
      ...
      ; make_field
          ...
          ~set:(fun s ->
            Client.Host.set_suspend_image_sr
              ...
              ( if s = ""
              then Ref.null
              else Client.SR.get_by_uuid rpc session_id s ) )
          ()
      ; make_field
          ~name:"crash-dump-sr-uuid"
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"virtual-hardware-platform-versions"
          ~get:(fun () ->
            map_and_concat
              Int64.to_string
...
let vdi_record rpc session_id vdi =
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~get:(fun () ->
            map_and_concat
              Record_util.vdi_operation_to_string
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~get:(fun () ->
            if (x ()).API.vBD_empty
            then "<EMPTY>"
            else get_name_from_ref (x ()).API.vBD_VDI )
          ()
      ; make_field
          ~name:"allowed-operations"
          ~get:(fun () ->
            map_and_concat
              Record_util.vbd_operation_to_string
...
let sr_record rpc session_id sr =
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~get:(fun () ->
            map_and_concat
              Record_util.sr_operation_to_string
...
let vm_appliance_record rpc session_id vm_appliance =
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~get:(fun () ->
            map_and_concat
              Record_util.vm_appliance_operation_to_string
...
let gpu_group_record rpc session_id gpu_group =
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~get:(fun () ->
            get_uuids_from_refs
              (Client.GPU_group.get_supported_VGPU_types
                 rpc
                 session_id
                 gpu_group ) )
          ()
      ; make_field
          ...
          ~set:(fun ty ->
            Client.GPU_group.set_allocation_algorithm
              rpc
              session_id
              gpu_group
...
let vgpu_record rpc session_id vgpu =
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~get:(fun () ->
            try
              Client.VGPU_type.get_model_name
                rpc
                session_id
                (x ()).API.vGPU_type
            with
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~set:(fun passthrough_enabled ->
            Client.PUSB.set_passthrough_enabled
              rpc
              session_id
              pusb
...
let vusb_record rpc session_id vusb =
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~get:(fun () ->
            map_and_concat
              Record_util.vusb_operation_to_string
...
let cluster_record rpc session_id cluster =
  ...
  ; fields =
      ...
      ; make_field
          ...
          ()
      ; make_field
          ~name:"token-timeout-coefficient"
          ~get:(fun () ->
      ...
      ; make_field
          ...
          ~get:(fun () ->
            map_and_concat
              Record_util.cluster_operation_to_string
...
let cluster_host_record rpc session_id cluster_host =
  ...
  ; fields =
      ...
      ; make_field
          ...
          ~get:(fun () ->
            map_and_concat
              Record_util.cluster_host_operation_to_string

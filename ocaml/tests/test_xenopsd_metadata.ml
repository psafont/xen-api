      ...
      (fun index (pgpu, vgpu_type) ->
        ...
        let (_ : API.ref_VGPU) =
          make_vgpu
            ~__context
            ~vm_ref
            ~scheduled_to_be_resident_on:pgpu_ref

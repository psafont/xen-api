  ...
  | _ ->
      ...
      let h' =
        Xapi_network.create
          ...
          ~name_description:internal_management_network_desc
          ~mTU:1500L
          ~other_config:internal_management_network_oc
          ~bridge:""
          ~managed:true
          ~tags:[]
      in
      Db.Network.set_bridge
        ...
        ~value:internal_management_bridge ;
      debug
        "Created new host internal management network: %s"
        (Ref.string_of h')

...
let doc =
  String.concat "\n"
    [
      "This is the xapi toolstack memory management daemon."
    ; ""
    ; "This service manages memory ballooning, also called DMC."
    ; "It also collects and reports memory metrics to the metrics service"
    ]
